...
import { FireExplosion } from './V1FireExplosion.js';
...
export class FlameProjectile extends Projectile {
  ...
  update(dt) {
    ...
    this.engine.entities.forEach(entity => {
      ...
      // Don't damage player (check tag for v2 compatibility)
      ...
      if (dist < 0.5) {
        ...
        if (died && this.engine.game) {
          ...
          // this.engine.sound.playHit(); // DISABLED
