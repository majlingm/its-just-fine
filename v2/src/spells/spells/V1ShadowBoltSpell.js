...
import { ShadowProjectile } from '../../entities/V1ShadowProjectile.js';
import { ShadowBoltGroup } from '../../entities/V1ShadowBoltGroup.js';
 ...
 */
export class V1ShadowBoltSpell extends ProjectileSpell {
  constructor(level = 1) {
